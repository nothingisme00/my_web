    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Tentang Saya</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="rounded-2xl bg-gray-50 p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900">DevAditya</h3>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["JavaScript", "TypeScript", "React", "Next.js", "Node.js", "Tailwind CSS", "Prisma", "PostgreSQL", "Docker", "AWS"].map((tech) => (
                  <span key={tech} className="inline-flex items-center rounded-md bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">
                    {tech}
                  </span>
                ))}
              </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            <section>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Pengalaman Kerja</h3>
              <div className="space-y-8">
                <div className="relative pl-8 border-l-2 border-gray-200">
                  <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full bg-blue-600 ring-4 ring-white" />
                  <div className="mb-1 flex items-center justify-between">
                    <h4 className="text-lg font-bold text-gray-900">Senior Frontend Engineer</h4>
                    <span className="text-sm text-gray-500">2022 - Sekarang</span>
                  </div>
                  <p className="text-blue-600 font-medium mb-2">Tech Startup Unicorn</p>
                ...
                <div className="relative pl-8 border-l-2 border-gray-200">
                  ...
                  <div className="mb-1 flex items-center justify-between">
                    <h4 className="text-lg font-bold text-gray-900">Web Developer</h4>
                    <span className="text-sm text-gray-500">2020 - 2022</span>
                  </div>
                  <p className="text-blue-600 font-medium mb-2">Digital Agency</p>
                  <p className="text-gray-600">
            ...
            <section>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Pendidikan</h3>
              <div className="space-y-8">
                <div className="relative pl-8 border-l-2 border-gray-200">
                  <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full bg-gray-300 ring-4 ring-white" />
                  <div className="mb-1 flex items-center justify-between">
                    <h4 className="text-lg font-bold text-gray-900">Sarjana Teknik Informatika</h4>
                    <span className="text-sm text-gray-500">2016 - 2020</span>
                  </div>
                  <p className="text-blue-600 font-medium mb-2">Universitas Teknologi</p>
                  <p className="text-gray-600">
